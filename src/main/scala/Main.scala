...
object Main {
  ...
  def main(args: Array[String]) {
     ...
     */
      ...
      val ARIs = Array(shape, scale, ariLBM1, ariLBM49, ariLBM_MS, ariNPLBM)
      val RIs = Array(shape, scale, riLBM1, riLBM49, riLBM_MS, riNPLBM)
      val NMIs = Array(shape, scale,  nmiLBM1, nmiLBM49, nmiLBM_MS, nmiNPLBM)
      val nClusters = Array(shape, scale, nClusterLBM1, nClusterLBM49, nClusterLBM_MS, nClusterNPLBM)
      val runtimes = Array(shape, scale, runtimeLBM1, runtimeLBM49, runtimeLBM_MS, runtimeNPLBM)
